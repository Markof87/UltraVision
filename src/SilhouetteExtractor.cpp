...
cv::Mat SilhouetteExtractor::extractSilhouette(const cv::Mat& frame) {
...
cv::Mat SilhouetteExtractor::backgroundSubtraction(const cv::Mat& frame) {
...
cv::Mat SilhouetteExtractor::thresholding(const cv::Mat& frame) {
