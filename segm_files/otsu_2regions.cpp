...
// Isola la variabile globale della trackbar
namespace {
...
void test_otsu_2regions() {
    ...
    while (true) {
        ...
        // Creiamo solo due rettangoli che prendono tutta la larghezza (cols)
        cv::Rect regions[2] = {
        ...
        // Disegno un'unica linea divisoria orizzontale verde sul pannello centrale
